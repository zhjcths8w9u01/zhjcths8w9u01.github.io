...
<!DOCTYPE html>
<html lang="en"><head>
<title>GOOD EXPERIENCE AT SHOPPER FACT - Home</title><meta property="og:site_name" content="GOOD EXPERIENCE AT SHOPPER FACT">
<meta property="og:title" content="GOOD EXPERIENCE AT SHOPPER FACT">
<meta property="og:description" content="Retail Secret Shopper® is the premier intelligence shopping company, serving clients across America and Canada with over 500,000 shoppers available and ready to help businesses better serve their...">
<meta property="og:url" content="">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link id="wsite-base-style" rel="stylesheet" type="text/css" href="media/sites.css">
<link rel="stylesheet" type="text/css" href="media/fancybox.css">
<link rel="stylesheet" type="text/css" href="media/social-icons.css" media="screen,projection">
<link rel="stylesheet" type="text/css" href="media/main_style.css" title="wsite-theme-css">
<link href="media/css_007.css" rel="stylesheet" type="text/css">
<link href="media/css.css" rel="stylesheet" type="text/css">
<link href="media/css_004.css" rel="stylesheet" type="text/css">
<link href="media/css_002.css" rel="stylesheet" type="text/css">
<link href="media/css_005.css" rel="stylesheet" type="text/css">
<link href="media/css_002.css" rel="stylesheet" type="text/css">
<link href="media/css_005.css" rel="stylesheet" type="text/css">
<link href="media/css_003.css" rel="stylesheet" type="text/css">
<link href="media/css_006.css" rel="stylesheet" type="text/css">
<style type="text/css">
.wsite-elements.wsite-not-footer:not(.wsite-header-elements) div.paragraph, .wsite-elements.wsite-not-footer:not(.wsite-header-elements) p, .wsite-elements.wsite-not-footer:not(.wsite-header-elements) .product-block .product-title, .wsite-elements.wsite-not-footer:not(.wsite-header-elements) .product-description, .wsite-elements.wsite-not-footer:not(.wsite-header-elements) .wsite-form-field label, .wsite-elements.wsite-not-footer:not(.wsite-header-elements) .wsite-form-field label, #wsite-content div.paragraph, #wsite-content p, #wsite-content .product-block .product-title, #wsite-content .product-description, #wsite-content .wsite-form-field label, #wsite-content .wsite-form-field label, .blog-sidebar div.paragraph, .blog-sidebar p, .blog-sidebar .wsite-form-field label, .blog-sidebar .wsite-form-field label {font-family:"Patua One" !important;letter-spacing: 0px !important;}
#wsite-content div.paragraph, #wsite-content p, #wsite-content .product-block .product-title, #wsite-content .product-description, #wsite-content .wsite-form-field label, #wsite-content .wsite-form-field label, .blog-sidebar div.paragraph, .blog-sidebar p, .blog-sidebar .wsite-form-field label, .blog-sidebar .wsite-form-field label {color:#525252 !important;}
.wsite-elements.wsite-footer div.paragraph, .wsite-elements.wsite-footer p, .wsite-elements.wsite-footer .product-block .product-title, .wsite-elements.wsite-footer .product-description, .wsite-elements.wsite-footer .wsite-form-field label, .wsite-elements.wsite-footer .wsite-form-field label{}
.wsite-elements.wsite-not-footer:not(.wsite-header-elements) h2, .wsite-elements.wsite-not-footer:not(.wsite-header-elements) .product-long .product-title, .wsite-elements.wsite-not-footer:not(.wsite-header-elements) .product-large .product-title, .wsite-elements.wsite-not-footer:not(.wsite-header-elements) .product-small .product-title, #wsite-content h2, #wsite-content .product-long .product-title, #wsite-content .product-large .product-title, #wsite-content .product-small .product-title, .blog-sidebar h2 {font-family:"Bree Serif" !important;text-transform:uppercase !important;letter-spacing: 1px !important;}
#wsite-content h2, #wsite-content .product-long .product-title, #wsite-content .product-large .product-title, #wsite-content .product-small .product-title, .blog-sidebar h2 {}
.wsite-elements.wsite-footer h2, .wsite-elements.wsite-footer .product-long .product-title, .wsite-elements.wsite-footer .product-large .product-title, .wsite-elements.wsite-footer .product-small .product-title{}
#wsite-title {font-family:"Patua One" !important;color:#525252 !important;}
.wsite-menu-default a {font-family:"Bree Serif" !important;letter-spacing: 3px !important;}
.wsite-menu a {}
...
<style>
.wsite-background {background-image: url("/uploads/1/2/7/4/127489413/background-images/961145962.jpeg") !important;background-repeat: no-repeat !important;background-position: 41.67% 24.55% !important;background-size: 100% !important;background-color: transparent !important;}
...
<body class="no-header-page wsite-theme-lightwsite-page-index" style="padding-bottom: 2.8em;"><div class="wrapper" style="margin-bottom: -142px;">
<div class="header-wrap">
<div class="nav-wrap">
<div id="logo"><span class="wsite-logo">
<a href="">
<span id="wsite-title">GOOD EXPERIENCE AT SHOPPER FACT</span>
</a>
</span></div>
...
<li id="pg774875217268287478" class="wsite-menu-item-wrap wsite-nav-2" style="position: relative;">
<a href="application-form.php" class="wsite-menu-item" style="position: relative;">
Application Form
</a>
</li>
</ul>
...
<div class="wsite-section wsite-body-section wsite-section-bg-image wsite-background-4 wsite-custom-background" style="height: 540px;background-image: url(&quot;media/shopping.jpg&quot;) ;background-repeat: no-repeat ;background-position: 50% 50% ;background-size: 100% ;background-color: transparent ;background-size: cover;">
...
<div class="wsite-section-wrap">
<div class="wsite-section wsite-body-section wsite-section-bg-image wsite-background-5 wsite-custom-background" style="height: 500px;vertical-align: middle;background-image: url(&quot;media/1637653434.png&quot;) ;background-repeat: no-repeat ;background-position: 0.00% 31.03% ;background-size: 100% ;background-color: transparent ;background-size: cover;">
<div class="wsite-section-content">
<div class="container">
<div class="wsite-section-elements">
...
<div class="paragraph"><font color="#414658">Retail Secret Shopper® is 
the premier intelligence shopping company, serving clients across 
America and Canada with over 500,000 shoppers available and ready to 
help businesses better serve their customers.<br><br>Continual 
investment in the latest internet and communication technologies coupled
 with over 16 years of know-how means working with Secret Shopper® is a 
satisfying and rewarding experience.<br><br>Retail Secret shopping as 
seen on ABC NEWS, NBC NEWS, L.A.TIMES. Stores and organizations such as 
The Gap, Wal-Mart, Moneygram and All Banks pay Secret Shoppers to shop 
in their establishments and give detailed report of their experience.<br><br>We
 pay you money for your shopping exercise and you are also allowed to 
keep purchases for free (so shop for items that would be useful to you).</font><br><br><font color="#414658">Our
 major point of interest is your survey report. Retail Secret Shopper® 
NEVER charge fees to the shopper. Training, tips for improvement, and 
shopping opportunities are provided free to registered shoppers.</font><br></div>
</td></tr>
</tbody>
</table>
</div></div></div>
...
<div class="sticky-footer-push" style="height: 142px;"></div>
</div><!--/.wrapper-->
<div id="footer-wrap" style="height: 142px;">
<div class="container"><div class="wsite-elements wsite-footer">
<div class="paragraph" style="text-align:center;">© 2020 Assign Retail Shopper Inc. All rights reserved.<br></div></div></div>
</div>
...
<li id="pg774875217268287478" class="wsite-menu-item-wrap">
<a href="application-form.php" class="wsite-menu-item">
Application Form
</a>
</li>
</ul></div></div>
...
<div><div class="kb-container" style=";" id="kbcontainer">
<div class="kb-content">
<div class="kb-description">This site uses cookies to personalize your experience, analyze site usage, and offer tailored promotions. <a style="color: #2990ea; text-decoration: none;" href="https://www.youronlinechoices.eu/" target="_blank">www.youronlinechoices.eu</a></div>
<a href="#" onclick="closeit();" class="kb-remind-link" id="kb-link">Remind me later</a>
<a href="#" onclick="closeit();" class="kb-notice-btn" id="kb-btn">I accept</a>
</div>
</div>
<style>
.kb-container {
